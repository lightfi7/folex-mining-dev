...
-- Dumping data for table folex.coinbase_payments: ~17 rows (approximately)
...
-- Dumping data for table folex.coinbase_webhooks: ~19 rows (approximately)
...
-- Dumping data for table folex.coin_data: ~3 rows (approximately)
...
INSERT INTO `coin_data` (`id`, `hashing_id`, `is_active`, `formula`, `unit`, `coin`, `data`, `coin_display_name`, `network_hashrate`, `difficulty`, `reward`, `reward_block`, `price`, `created_at`, `updated_at`) VALUES
	(1, '1', 1, '<price> / ( 1 / ( (<reward_block> * ( <total_hash> * 1000000000000 ) * 86400 ) / ( <difficulty> * 4294967296 ) ) )', 'TH/s', 'BTC', '{"id":"a195fd59ce0ebc3f9b2d99b3c396ff198bcb4a5e","coin":"BTC","name":"Bitcoin","type":"coin","algorithm":"SHA-256","network_hashrate":5.3151289185755e+20,"difficulty":70343519904866,"reward":7.4472950590146e-20,"reward_unit":"BTC","reward_block":6.25,"price":39566.935752417,"volume":16215933409.967,"updated":1705953252}', 'BTC', '5.3151289185755E+20', '70343519904866', '7.4472950590146E-20', '6.25', '39566.935752417', '2024-01-10 10:07:11', '2024-01-22 11:08:59'),
	(2, '2', 1, '<price> / ( 1 / ( ( ( ( <total_hash> * 1000000 ) * <reward_block> ) / <difficulty> ) * 86400 ) )', 'MH/s', 'BINANCE ETHW', '{"id":"a4ffb5b5b721c91643ae5e038d87d0e9ab1665dd","coin":"BINANCE ETHW","name":"Binance","type":"pool","algorithm":"Ethash","network_hashrate":-1,"difficulty":-1,"reward":4.2715e-11,"reward_unit":"ETHW","reward_block":-1,"price":2.6135005009229,"volume":-1,"updated":1705953601}', 'ETHW', '-1', '-1', '4.2715E-11', '-1', '2.6135005009229', '2024-01-10 10:07:11', '2024-01-22 11:09:18'),
	(3, '3', 1, '<price> / ( 1 / ( ( ( ( <total_hash> * 1000 ) * <reward_block> ) / ( <difficulty> * 3600 )  ) * 86400 ) )', 'KH/s', 'KAS', '{"id":"7ae4e0240e6cd4690300f55430f54ef5137062de","coin":"KAS","name":"Kaspa","type":"coin","algorithm":"KHeavyHash","network_hashrate":1.4303914779414e+17,"difficulty":33303896.84861,"reward":3.4880572451261e-12,"reward_unit":"KAS","reward_block":138.5913155,"price":0.097931874378632,"volume":19825999.627175,"updated":1705953263}', 'KAS', '1.4303914779414E+17', '33303896.84861', '3.4880572451261E-12', '138.5913155', '0.097931874378632', '2024-01-10 10:07:12', '2024-01-22 11:10:14');
...
-- Dumping data for table folex.deposit_requests: ~37 rows (approximately)
...
-- Dumping data for table folex.hashings: ~3 rows (approximately)
...
INSERT INTO `hashings` (`id`, `name`, `price_khs`, `cost_per_kwh`, `power_consumption`, `maintenance_fee`, `min_buyable`, `max_buyable`, `created_at`, `updated_at`) VALUES
	(1, 'SHA-256', 20, 350, 12.5, 14, 500, 2000, NULL, '2024-01-21 11:55:51'),
	(2, 'Ethash', 23, 300, 34, 23, 310, 5000, NULL, '2024-01-21 11:54:34'),
...
-- Dumping data for table folex.ledgers: ~121 rows (approximately)
DELETE FROM `ledgers`;
...
-- Dumping data for table folex.migrations: ~67 rows (approximately)
...
-- Dumping data for table folex.password_resets: ~3 rows (approximately)
...
-- Dumping data for table folex.payments: ~17 rows (approximately)
...
-- Dumping data for table folex.sessions: ~3 rows (approximately)
DELETE FROM `sessions`;
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('DTPyYnBhN9vNTK5teQ2QGzbIbiriiSoNYbBcYXdk', 14, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0', '', 1719742276),
	('OI1O0Ff4x5qBHCBjQbnH68hits0RETDGaIyiYAjS', 14, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0', '', 1719761063),
	('pjZAmqnvIAiF5yXZ1qDbG8SzOtaV14zVow3phKNJ', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0', '', 1719883093);
...
-- Dumping data for table folex.stripe_payments: ~26 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `twofa_code` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
-- Dumping data for table folex.users: ~12 rows (approximately)
DELETE FROM `users`;
INSERT INTO `users` (`id`, `public_id`, `first_name`, `last_name`, `email`, `password`, `mailchimp_id`, `is_mailchimp_synced`, `stripe_customer_id`, `stripe_full_name`, `two_factor_secret`, `two_factor_recovery_codes`, `avatar`, `twofa_code`, `role_id`, `referred_by`, `phone`, `address`, `country`, `city`, `state`, `zip`, `email_verified_at`, `created_at`, `updated_at`, `deleted_at`, `remember_token`, `locale`) VALUES
	(1, 'e851ac33-3402-4a82-90be-2933a9f1bf7b', 'Super', 'Admin', 'super@folex.com', '$2y$10$vsGvN8aC2DfknWEhtzVt4.L5EYhh8cLBt1lT5MU.U63ppXWyUAXUq', NULL, 0, NULL, NULL, 'eyJpdiI6IlBlVzBUVkh4ZUNnZEVuUE1qR1BDNmc9PSIsInZhbHVlIjoiVS9KbGZuWHJPNytGd1hWdExZdVhKZz09IiwibWFjIjoiZTFkMmM1OWUyOTU2ZjM5ZmRiOGI0NGZiZWVlYjUzN2ZmNWUzMjc2ZTNjMDIzMTMzODgzODE5NWYzNjgzNTY4ZCJ9', NULL, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-01-22 11:20:47', NULL, NULL, 'en'),
	...
	(3, 'fd698b52-4a51-453d-939c-90289f2528d2', 'Users', 'Users', 'user@folex.com', '$2y$10$mwcwLxt/BUFdw5ytay9Vaea5kLwx5aw3SGIAB.t4ApQ/VxN2treKi', NULL, 0, 'cus_PMDl5seQLZAETJ', 'dgsfdsf', 'eyJpdiI6IjlFbVRrYkkyZllWRWlHU1pwcmoxc2c9PSIsInZhbHVlIjoiOWlrTkRNN0RpTlk0TGFhQXVIS1FMQT09IiwibWFjIjoiZDMxZjIzNjg3OGU4Y2EwNjdhNmVkMmZkNDI3Mjg4NjlmZGJhNmRlZTgyZWZjMjA0NTk0OGJiMWU4NDFiMDEyOCJ9', NULL, NULL, NULL, '3', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-01-22 08:48:10', NULL, NULL, 'de'),
	...
	(14, '1343f3cf-8897-48b3-9ac6-d5e24f4d4a32', 'john', 'doe', 'light7fi@outlook.com', '$2y$10$MPc/iPZVUcMG.AvWCcHbf.7ykqN3kGDCxZdEPWEWnjUQRORx8rLCK', NULL, 0, NULL, NULL, 'eyJpdiI6ImlXditQeDFobUdSSDBjOE1MbHd4V2c9PSIsInZhbHVlIjoiY1o0YW45NStmMkdQRFVXMkRHSW5pQT09IiwibWFjIjoiZGEyMWZjYzc5NDgwNGJlMTZmODk0MmFkNjNlY2FlNmQzYzExZTc1NGE3ZmQ1MGExMmNjZjJmZmQ5ZWM0ZTRmZCIsInRhZyI6IiJ9', NULL, NULL, NULL, '3', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-06-25 09:54:55', '2024-06-30 07:15:10', NULL, NULL, 'en');
...
-- Dumping data for table folex.user_banks: ~5 rows (approximately)
...
-- Dumping data for table folex.user_cryptos: ~4 rows (approximately)
...
-- Dumping data for table folex.wallets: ~6 rows (approximately)
DELETE FROM `wallets`;
...
-- Dumping data for table folex.withdraw_requests: ~9 rows (approximately)
