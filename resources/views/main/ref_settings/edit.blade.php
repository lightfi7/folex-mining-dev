    ...
    <div class="px-3 px-xxl-5 py-3 py-lg-4 border-bottom border-gray-200 after-header">
        <div class="container-fluid px-0">
            <div class="row align-items-center">
                <div class="col">
                    <span class="text-uppercase tiny text-gray-600 Montserrat-font font-weight-semibold"><a href="{{url('ref-settings')}}">Ref Settings</a></span>
                ...
                <div class="card rounded-12 shadow-dark-80 border border-gray-50 mb-3 mb-xl-5">
                    ...
                    <div class="card-body px-0 p-md-4">
                        <div class="bd-example">
                            <form action="{{ url('ref-settings'."/".@$record->id) }}" method="POST" class="ajax-form px-3" class="form-horizontal">
                                @csrf()
                                @method('PUT')
